...
class Client:
    ...
    def __init__(self):
        ...
        # Cache initialized to predefined `typing._SpecialForm`'s
        self.module_name_name_tuple_to_lookup_result_dict: dict[
            tuple[str, str],
            TypeshedTypeAnnotation
        ] = {
            module_name_name_tuple: type_annotation
            for module_name_name_tuple, type_annotation in
            special_form_module_name_name_tuple_to_type_annotation.items()
        }
    ...
    def parse_ast_class_def_to_definition(
        ...
        if class_def.bases:
            ...
            for base in class_def.bases:
                ...
                base_class_definition = self.get_class_definition(base_class)
        ...
        for child_node_name, child_node in child_nodes.items():
            ...
            # Method or property
                ...
                if isinstance(child_node_ast.value, ast.Name):
                    ...
                    type_annotation = self.parse_ast_expr_to_type_annotation(class_.module_name, child_node_ast.value)
                    class_variable_name_to_type_annotation_dict[child_node_name] = type_annotation
            else:
                assert False, f"Cannot resolve node {ast.unparse(child_node_ast)} in class {class_}"
    ...
    def get_class_definition(self, concrete_class: TypeshedClass) -> TypeshedClassDefinition:
        if concrete_class in self.concrete_class_to_class_definition_dict:
            return self.concrete_class_to_class_definition_dict[concrete_class]
        else:
            ...
            if isinstance(name_info.ast, ast.ClassDef):
                ...
                return_value = TypeshedClassDefinition(
