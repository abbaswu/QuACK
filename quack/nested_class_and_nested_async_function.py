...
if __name__ == "__main__":
    ...
    # List comprehension to create a list of tasks
    tasks = [fetch_and_process(Outer.Inner.get_url) for _ in range(2)]

    # Execute the tasks concurrently
    results = asyncio.run(asyncio.gather(*tasks))
    print(f"Average of numbers fetched from URLs: {results}")
