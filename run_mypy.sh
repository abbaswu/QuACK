...
# Run mypy
mypy_command="conda run --no-capture-output --name mypy mypy --check-untyped-defs --no-warn-no-return --no-strict-optional --disable-error-code override --disable-error-code assignment $mypy_module_option_string"
